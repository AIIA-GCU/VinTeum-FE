...
class RegisterRequest {
  ...
  RegisterRequest({required this.username, required this.password, required this.nickname});
...
class RegisterProvider with ChangeNotifier {
  Future<void> register(String username, String password, String nickname) async {
    final url = Uri.parse('210.102.178.161:8081'); // API URL로 변경
    final registerRequest = RegisterRequest(username: username, password: password, nickname: nickname);
